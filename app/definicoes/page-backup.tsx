  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Acompanhe sua evolução emocional",
          icon: TrendingUp,
          href: "/bem-estar/historico",
  ...
  const appSettings = [
    {
      ...
      description: "Configure lembretes personalizados e marcos",
      icon: Bell,
      action: () => {
        haptics.light()
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-cyan-50 pb-20">
      ...
      {showEnhancedNotifications && (
        <NotificationSettings onClose={() => setShowEnhancedNotifications(false)} />
      )}
